  ...
  >
    <el-form ref="formRef" :model="form" :rules="rules" label-width="100px">
      ...
      <el-form-item label="充值金额" prop="rechargeMoney">
        <el-input type="number" v-model.number="form.rechargeMoney" placeholder="0.01~99999">
...
import { batchRecharge } from '@/api/subsidy'
...
const save = async () => {
  try {
    loading.value = true
    await batchRecharge({ ...form, customerIds: customers.value })
