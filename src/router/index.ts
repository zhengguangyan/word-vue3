...
export const asyncRouterMap: AppRouteRecordRaw[] = [
  ...
  //         {
  //           path: 'custom-table',
  //           component: () => import('@/views/Components/Table/CustomTable.vue'),
  //           name: 'CustomTable',
  //           meta: {
  //             title: 'CustomTable'
  //           }
  ...
  //     // {
  //     //   path: 'post',
  //     //   component: () => import('@/views/Authorization/Post.vue'),
  //     //   name: 'Post',
  //     //   meta: {
  //     //     title: t('router.post')
  //     //   }
  ...
  //       name: 'Dict',
  //       meta: {
  //         title: t('router.dictionary')
  //       }
  //     },
  //     {
  //       path: 'area',
  //       component: () => import('/src/views/system/area/index.vue'),
  //       name: 'Area',
  //       meta: {
  //         title: t('router.project')
  //       }
  //     },
  //     {
  //       path: 'config',
  //       component: () => import('/src/views/system/config/index.vue'),
  //       name: 'Config',
  //       meta: {
  ...
  //           path: 'operlog',
  //           name: 'Operlog',
  //           component: () => import('/src/views/system/operlog/index.vue'),
  //           meta: {
  //             title: t('router.operatelog')
  //           }
  //         },
  //         {
  //           path: 'logininfor',
