...
export const colorConfig: any = {
  ...
  '#409eff': {
    elColorPrimaryRgb: '64, 158, 255',
    elColorPrimaryLight3: '#79bbff',
    elColorPrimaryLight5: '#a0cfff',
    elColorPrimaryLight7: '#c6e2ff',
    elColorPrimaryLight8: '#d9ecff',
    elColorPrimaryLight9: '#ecf5ff',
    elColorPrimaryDark2: '#337ecc'
  }
}
