...
export const useRenderLayout = () => {
      ...
      <>
        ...
        <div
          class={[
            ...
            {
              'w-[calc(100%-var(--left-menu-min-width)-20px)] left-[var(--left-menu-min-width)]':
                collapse.value && !mobile.value && !mobile.value,
              'w-[calc(100%-var(--left-menu-max-width)-20px)] left-[var(--left-menu-max-width)]':
                !collapse.value && !mobile.value && !mobile.value,
        ...
        >
          <ElScrollbar
            ...
            class={[
              ...
              {
                '!h-[calc(100%-var(--top-tool-height)-var(--tags-view-height))] mt-[calc(var(--top-tool-height)+var(--tags-view-height)+20px)]':
                  fixedHeader.value
              }
            ]}
          >
  ...
  const renderTopLeft = () => {
    return (
      <>
        <div class="top flex items-center bg-[var(--top-header-bg-color)] border-solid border-[var(--top-tool-border-color)] dark:border-[var(--el-border-color)]">
          ...
          >
            <ElScrollbar
              ...
              class={[
                `${prefixCls}-content-scrollbar`,
                {
                  '!h-[calc(100%-var(--tags-view-height))] mt-[calc(var(--tags-view-height)+20px)]':
              ...
              {tagsView.value ? (
                <TagsView
                  class={[
                    ...
                    {
                      '!fixed top-0 left-0 z-10': fixedHeader.value,
                      'w-[calc(100%-var(--left-menu-min-width)-20px)] left-[var(--left-menu-min-width)] mt-[var(--logo-height)]':
                        collapse.value && fixedHeader.value,
                      'w-[calc(100%-var(--left-menu-max-width)-20px)] left-[var(--left-menu-max-width)] mt-[var(--logo-height)]':
                        !collapse.value && fixedHeader.value
                    }
                  ]}
  ...
  const renderTop = () => {
    return (
      <>
        <div class="layout-top-header flex items-center justify-between bg-[var(--top-header-bg-color)] border-bottom-1 border-solid border-[var(--top-tool-border-color)] dark:border-[var(--el-border-color)]">
