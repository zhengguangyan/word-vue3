...
const emit = defineEmits(['keyup', 'search', 'reset'])
...
<template>
  <Form :is-custom="false" @keyup.enter="keyup" :label-width="labelWidth" hide-required-asterisk :inline="inline" :is-col="isCol" :schema="newSchema" :showFormLabel="false" @register="register">
    <template #action>
